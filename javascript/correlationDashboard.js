...
function dashboardCorr(id, topicData, corrData){
    ...
    function topHist(histData){
        ...
        TopHgSVG.append("g").attr("class","histAxis")
    ...
    function botHist(histData){
        var BotHg={},    BotHgDim = {t: 50, r: 10, b: 90, l: 30};
        ...
        // create scale in x
        var x = d3.scale.ordinal()
                  .rangeRoundBands([BotHgDim.l, BotHgDim.w], 0.1)
                  .domain(histData.map(function(d) { return d[0]; }));
        ...
        BotHgSVG.append("g").attr("class","histAxis")
